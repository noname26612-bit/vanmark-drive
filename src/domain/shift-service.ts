...
export type ShiftView = {
  ...
  // «Водители» (№5). Заполняется только в listShiftsForDate; в одиночных ответах не нужно.
 ...
 * дня + текущая активная (старт → сейчас). Для полосы рабочего времени на «Водителях» (№5).
