...
export type SummaryOverview = {
  ...
  /**
   * Рабочий день из настроек ёмкости, мин (Сводка v3, 22.08.2026). Даёт графику по дням
   * ФИКСИРОВАННУЮ шкалу: до сих пор высота столбика считалась от максимума окна, и «полный столбик»
   * означал то 9 часов, то 40 минут — сравнивать дни глазами было нельзя.
   */
