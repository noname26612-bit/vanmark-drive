...
export type TaskDTO = {
  ...
  number: number;
  /**
   * Номер задачи цеха («Ц-N», 16.08.2026): null у доставок, а у старых клиентов поля нет вовсе.
   * Показывать через `taskNumberLabel` из @/lib/task-number, а не собирать строку руками.
   */
