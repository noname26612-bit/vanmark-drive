...
import { parseCategory, parseFlag, parseInt0, parseMachineFields, parseMachineStatus } from "@/lib/machine-input";
import { Errors } from "@/domain/errors";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

// GET /api/machines?scope=active|archive&category&status&flag&q&take&skip — картотека + счётчики
// сводки. Доступ: менеджер-сервисник / диспетчер / админ (водителю — 404, см. requireMachineUser).
