...
//
// Правка (canManage) — у диспетчера и админа. Менеджер-сервисник смотрит: сервер всё равно ответит
// 403, и кнопки, ведущие в отказ, показывать нельзя (то же правило, что у вкладок в меню).
